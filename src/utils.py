...
class DocumentEditor:
    def __init__(
        self, documento_entrada, documento_saida="termoentrega_modificado.docx"
    ):
        ...
        try:
            ...
            if not os.path.exists(caminho_soffice):
                raise FileNotFoundError(
                    f"LibreOffice não encontrado em: {caminho_soffice}"
                )
    ...
    def salvar(self, nome_colaborador=None):
        ...
        if nome_colaborador:
            self.converter_para_pdf_libreoffice(
                nomedoc=documento_saida
            )  # Converte o documento para PDF usando LibreOffice
...
class SheetsHandler:
    ...
    def exibir_resultados(self, resultados):
        if resultados:
            ...
            for aba, linha, valores in resultados:
                ...
                print(
                    f"Proprietário: {self.nome_proprietario}"
                ) if self.nome_proprietario else print("Proprietário não encontrado.")
    ...
    def altera_valor_planilha(self, spreadsheet_id, aba, coluna, linha, valor):
        ...
        try:
            ...
            print("✔️ Proprietário atualizado na planilha.") if coluna == "a" else print(
                "✔️ Departamento atualizado na planilha."
            )
